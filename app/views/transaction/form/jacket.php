<?php
$pageTitle    = 'Konfigurasi Jacket - Siblings.co';
$formHeading  = 'Konfigurasi Custom Jacket';
...
<form action="<?= url('/transactions/cart') ?>" method="POST" enctype="multipart/form-data">
    <?= csrf_field() ?>
    <input type="hidden" name="kategori" value="Jacket">
    <input type="hidden" id="variantId" name="variant_id" value="<?= e($editItem['variant_id'] ?? '') ?>">
    <input type="hidden" name="form_source" value="<?= e($formSource ?? 'jacket') ?>">
    ...
    <div class="form-grid">
        <section class="form-card" aria-labelledby="jacketSpec">
            <div class="form-card__header" id="jacketSpec">
                <i class="fas fa-tshirt" aria-hidden="true"></i>
                Spesifikasi Produk
            </div>
            <div class="form-card__body">
                <div class="form-field">
                    <label class="form-field__label" for="paketBahan">Pilih Jenis Bahan Jacket</label>
        ...
        <section class="form-card" aria-labelledby="jacketSize">
            <div class="form-card__header" id="jacketSize">
