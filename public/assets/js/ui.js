...
(function () {
    ...
    function bindFormLoading() {
        document.addEventListener("submit", (e) => {
            ...
            // Check validity before disabling — if invalid, don't enter loading state
            ...
            if (loadingLabel) {
                ...
                submitBtn.innerHTML = `<i class="fas fa-spinner fa-spin" aria-hidden="true"></i> ${loadingLabel}`;
            }
    ...
    function initCustomSelect(selectEl) {
        ...
        const searchHTML = searchable
            ? '<div class="custom-select__search-wrap"><input class="custom-select__search" type="text" placeholder="Cari…" autocomplete="off" tabindex="-1"></div>'
            : "";
        ...
        bindCustomSelectEvents(wrapper, selectEl, searchable);
    }

    function bindCustomSelectEvents(wrapper, nativeSelect, searchable) {
        const trigger = wrapper.querySelector(".custom-select__trigger");
        ...
        const searchInput = searchable ? wrapper.querySelector(".custom-select__search") : null;
    ...
    function refreshCustomSelect(selectEl) {
        ...
        delete selectEl.dataset.customInit;
        // Reset inline styles set by initCustomSelect
    ...
    /**
     * withLoading — execute async function with button loading state.
    ...
    async function withLoading(btn, asyncFn) {
        ...
        const originalLabel = btn.dataset.loadingLabel || "Memproses…";
        btn.disabled = true;
        btn.setAttribute("aria-busy", "true");
        btn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> ' + originalLabel;
    ...
    // CSRF token reader
    SiblingsUI.getCsrfToken = function () {
